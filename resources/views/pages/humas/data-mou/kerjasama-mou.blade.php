...
<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kerja Sama</li>
    </ol>
        ...
        <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <main class="form-Tamu">
                <form action="/kerjasama-mou" method="" class="row g-3 py-1 px-4">
                  @csrf
                    <div class="col-md-6">
                        <label class="form-label" for="nama">Nama Mitra</label>
                        <div class="input-group">
                            <input 
                            type="text" name="nama" class="form-control rounded-3" 
                            {{-- id="nama" required
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-floating mb-3" > 
                            <textarea class="form-control" name="keteranganTamu" placeholder="Leave a comment here" id="floatingTextarea" style="height: 120px"  ></textarea>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="date" name="tgl_berakhir" class="form-control rounded-3"
                                required value="{{ old('tanggal_lahir') }}"
                                {{ $errors->has('tanggal_lahir') ? 'autofocus="true"' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-end" style="gap: 10px">
                        <a href="/kerjasama-mou" type="button" class="btn btn-danger text-sm rounded-3"
